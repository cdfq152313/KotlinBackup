...
/**
 * Created by denny on 2018/1/27.
 */

public class MyTOTPBuilder {
    ...
    public static final int MIN_ALLOWED_DIGITS = 4;
    ...
    /**
     * Creates a new instance of {@code MyTOTPBuilder} initialized with a shared
     * secret key.
     *
     * @param key
    ...
    /**
     * Returns this {@code MyTOTPBuilder} instance initialized with the specified
     * {@code timeStep} size.
     *
     * @param timeStep
     *            the time step size in milliseconds
     *
     * @return this {@code MyTOTPBuilder} instance initialized with the specified
     *         {@code timeStep} size.
     *
     * @throws IllegalArgumentException
     *             if {@code timeStep} is {@literal <=} 0.
     */
    public MyTOTPBuilder timeStep(long timeStep) {
     ...
     */
    public MyTOTPBuilder digits(int digits) {
     ...
     */
    public MyTOTPBuilder hmacSha(HmacShaAlgorithm algorithm) {
    ...
    /**
     * Returns this {@code MyTOTPBuilder} instance initialized with the
     * {@link HmacShaAlgorithm#HMAC_SHA_1}.
     *
     * @return this {@code MyTOTPBuilder} instance initialized with the
     *         {@link HmacShaAlgorithm#HMAC_SHA_1}.
     */
    public MyTOTPBuilder hmacSha1() {
     ...
     *         {@link HmacShaAlgorithm#HMAC_SHA_256}.
     */
    public MyTOTPBuilder hmacSha256() {
     ...
     *         {@link HmacShaAlgorithm#HMAC_SHA_512}.
     */
    public MyTOTPBuilder hmacSha512() {
